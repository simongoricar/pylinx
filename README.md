...
## 3. Configuration
Before you start using, you must copy and rename the provided example configuration file. Fill out `linx_instance_url` and `linx_api_key` (corresponds to `authfile` on the [server](https://github.com/andreimarcu/linx-server)).
